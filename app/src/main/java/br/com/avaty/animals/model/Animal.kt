...
//http://us-central1-apis-4674e.cloudfunctions.net/getKey
data class ApiKey(
    val message: String?,
    val key: String?
)

//http://us-central1-apis-4674e.cloudfunctions.net/getAnimals
//String? qr dizer que a variavel name pode ser nula
data class Animal(
    val name: String?,
